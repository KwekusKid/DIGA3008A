    ...
    const forms = [
        {
            id: 'sketches',
            title: 'Sketches',
            description: 'These are my first Wireframes alongisde quick sketches I would do before conceptualizing a page fully. I loved the idea of a symmetrical layout where majority of my content was centered vertically throughout the page. At the time of earlier wireframes,  I didn\'t have the clearest picture of the type of content that I\'d put on here, eventually however I did realize this sort of structure would be hard to maintain and keep up an easy user experience. I use sketches to map out the content and not focus to heavily on the details of the page but more so its overall appearance. They\'re usually drawn out in seconds but vital in my design process.',
            galleryImages: [
        ...
        },
        {
            id: 'wireframes-v1',
            title: 'Wireframes v1',
            description: 'My early attempts at high fidelity wireframes. I was obsessed with this idea of a home icon at the top left corner of each page as the main form of navigation for the website. But here you\'ll find the websites early connections to aesthetics in minimalism. At the time, majority of my influence in terms of websites and web design came from websites around fashion, i.e Wales Bonner and Martin Rose which are tend to go down a minimalistic route. Lightboxes, a concept I didn\'t understand at the time of these making these wireframes, were going to be littered all over the website. I originally planned all my blog posts to be on one page. I\'d navigate this using lightboxes. I dropped this idea due to the ethics and accessability of having having these pages stuffed with content, however the ability and at this point, I\'d call a skill, to retain and use space for the aesthetic of the website while managing huge amounts of written content remains a characteristics of this website. It began in these wireframes.',
            galleryImages: [
        ...
        },
        {
            id: 'wireframes-v2',
            title: 'Wireframes v2',
            description: 'My final set of wireframes, these are accurate representations of what I want my final website to be. They include colour, layout and even the placement of content. The idea of a minimalism design was a huge focus. Using space well to leave room for visuals to shine but also work as navigation tools, for example in my design home page. I wanted the user experience to feel sleek and my website to carry its own experience that wouldn\'t be found on most websites',
            galleryImages: [
